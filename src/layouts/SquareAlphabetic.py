...
class SquareAlphabetic(tk.Tk):
    ...
    def layout(self):
        ...
        A.grid(row = 3 , column = 5, ipadx = 6 , ipady = 10)
        ...
        D.grid(row = 3 , column = 8, ipadx = 6 , ipady = 10)
        
        E = ttk.Button(text = 'E' , width = 6, command = lambda : press('E'))
        E.grid(row = 3 , column = 9, ipadx = 6 , ipady = 10)
        
        exclamation = ttk.Button(text = '!' , width = 6, command = lambda : press('!'))
        exclamation.grid(row = 3 , column = 10, ipadx = 6 , ipady = 10)
