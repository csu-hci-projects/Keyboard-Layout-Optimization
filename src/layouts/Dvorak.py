...
def Dvorak(entry):
    ...
    O.grid(row = 3 , column = 1, ipadx = 6 , ipady = 10)
    
    E = ttk.Button(text = 'E' , width = 6, command = lambda : press('E', entry))
    E.grid(row = 3 , column = 2, ipadx = 6 , ipady = 10)
    
    U = ttk.Button(text = 'U' , width = 6, command = lambda : press('U', entry))
    U.grid(row = 3 , column = 3, ipadx = 6 , ipady = 10)
    ...
    W.grid(row = 4 , column = 7, ipadx = 6 , ipady = 10)
    
    V = ttk.Button(text = 'V' , width = 6, command = lambda : press('V', entry))
    V.grid(row = 4 , column = 8, ipadx = 6 , ipady = 10)

    Z = ttk.Button(text = 'Z' , width = 6, command = lambda : press('Z', entry))
    Z.grid(row = 4 , column = 9, ipadx = 6 , ipady = 10)
