...
class QWERTY(tk.Tk):
    ...
    def layout(self):
        ...
        F.grid(row = 4 , column = 10, ipadx = 6 , ipady = 10)
        
        G = ttk.Button(text = 'G' , width = 6, command = lambda : press('G'))
        G.grid(row = 4 , column = 11, ipadx = 6 , ipady = 10)
        
        C = ttk.Button(text = 'C' , width = 6, command = lambda : press('C'))
        C.grid(row = 5 , column = 12, ipadx = 6 , ipady = 10)
        ...
        L.grid(row = 4 , column = 14, ipadx = 6 , ipady = 10)
