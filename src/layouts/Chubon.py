...
def Chubon(entry):
    ...
    T.grid(row = 3 , column = 4, ipadx = 6 , ipady = 10)
        
    S = ttk.Button(text = 'S' , width = 6, command = lambda : press('S', entry))
    S.grid(row = 3 , column = 5, ipadx = 6 , ipady = 10)
        
    C = ttk.Button(text = 'C' , width = 6, command = lambda : press('C', entry))
    C.grid(row = 3 , column = 6, ipadx = 6 , ipady = 10)
    ...
    Z.grid(row = 3 , column = 8, ipadx = 6 , ipady = 10)
    ...
    G.grid(row = 4 , column = 1, ipadx = 6 , ipady = 10)
       
    N = ttk.Button(text = 'N' , width = 6, command = lambda : press('N', entry))
    N.grid(row = 4 , column = 2, ipadx = 6 , ipady = 10)     
      
    R = ttk.Button(text = 'R' , width = 6, command = lambda : press('R', entry))
    R.grid(row = 4 , column = 3, ipadx = 6 , ipady = 10)
    ...
    H.grid(row = 4 , column = 5, ipadx = 6 , ipady = 10)
