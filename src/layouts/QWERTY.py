...
class QWERTY(tk.Tk):
    ...
    def layout(self):
        ...
        N.grid(row = 5 , column = 11, ipadx = 6 , ipady = 10)


        M = ttk.Button(text = 'M' , width = 6, command = lambda : press('M'))
        M.grid(row = 5 , column = 12, ipadx = 6 , ipady = 10)